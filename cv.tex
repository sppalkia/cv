...
\cventry{Summer 2019}{Research Intern}{Google Inc.}{Sunnyvale, CA}{} {
\begin{itemize}
  \item Explored the use cache-coherent interconnects (CXL) in the context of various Google systems.
\end{itemize}
}
